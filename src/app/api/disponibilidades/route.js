...
import { listar, criar } from "@/controllers/disponibilidadeController";
...
export async function GET(request) {
  ...
  const search = {
    profissional_id: searchParams.get("profissional_id") || undefined,
    dia_semana: searchParams.get("dia_semana") || undefined,
  };
  const pagination = { offset: searchParams.get("offset") || 0, limit: searchParams.get("limit") || 200 };
